...
import {
  ...
  Activity, ClipboardList, BookOpen, CalendarDays, Music, Rocket, Layers, BookImage, Newspaper, FileText,
} from 'lucide-react';
        ...
        {isAdmin && (
          <>
            ...
            {[
              ...
              { to: '/dashboard/tutoriais',  icon: BookImage,  label: 'Tutoriais do App' },
              { to: '/dashboard/posts',      icon: Newspaper,  label: 'Posts do App' },
              { to: '/dashboard/pdfs',       icon: FileText,   label: 'PDFs & Documentos' },
